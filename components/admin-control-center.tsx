              ...
              {pendingHalls.length > 0 ? (
                pendingHalls.map((hall) => (
                  <tr key={hall.id} className="align-top">
                    ...
                    <td className="px-4 py-4 text-zinc-700">{hall.capacity}</td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          className="rounded-full bg-emerald-600 px-4 py-2 text-xs font-semibold text-white transition hover:bg-emerald-500 disabled:opacity-50"
                        >
                ...
                complaints.map((complaint) => (
                  <tr key={complaint.id} className="align-top">
                    ...
                    <td className="px-4 py-4 max-w-md">
                      ...
                      <div className="mt-1 text-zinc-600 leading-relaxed italic">
                        "{complaint.message}"
                      </div>
                    </td>
                    <td className="px-4 py-4">
                    ...
                    <td className="px-4 py-4">
                      {complaint.status === "PENDING" ? (
                        <button
                          ...
                          className="rounded-full bg-zinc-950 px-4 py-2 text-xs font-bold text-white transition hover:bg-zinc-800 disabled:opacity-50"
                        >
